...
class ProdutosController extends AppController
{
    ...
    public function add()
    {
        ...
        $tipoProdutos = TableRegistry::get('TipoProdutos')->find('list', ['limit' => 200]);
        $this->set(compact('produto','grupoProdutos','tipoProdutos'));
    }
    ...
    {
        $pedidos = TableRegistry::get('Pedidos')->find()->join([
            'table'=>'pedido_produtos',
            'alias'=>'PedidoProdutos',
            'conditions'=>'PedidoProdutos.pedido_id = Pedidos.id',
            'type'=>'LEFT'
        ])->contain(['Clientes','PedidoProdutos'=>['UnidadeMedidas']])->where(['PedidoProdutos.produto_id'=>$id]);
        // Buscar metodo eficaz
        $produto = $this->Produtos->get($id,['contain'=>'GrupoProdutos']);
