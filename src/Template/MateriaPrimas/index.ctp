<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Matéria-primas<?=$this->Html->link('<i class="fe fe-plus"></i> Novo', ['action'=>'add'],['class'=>'btn btn-pill btn-success btn-sm float-right _colorbox','escape'=>false])?></h3>
        </div>
        <div class="card-body">
            <table class="table card-table table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $materiaPrima->tipo_materia_prima->nome ?></td>
                        <td><?= h($materiaPrima->nome) ?></td>
                        <td><?= $this->Number->format($materiaPrima->estoque_minimo) ?></td>
                        <td class="actions">
                            <?= $this->Html->link('<i class="fe fe-edit"></i>', ['action' => 'edit', $materiaPrima->id],['escape'=>false,'class'=>'_colorbox']) ?>
